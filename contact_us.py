...
class ContactUsPage(tk.Frame):
    def __init__(self, master, show_homepage, ID):
        ...
        # Title
        title_label = tk.Label(self, text="Meet the Developers!", font=("Arial", 24, "bold"), bg='grey', fg='black')
        ...
        aarush_blurb = tk.Label(content_frame, text="Email: tuta260@aa.edu \nPhone: 505-908-4489", 
        ...
        harrison_blurb = tk.Label(content_frame, text="Email: schh260@aa.edu \nPhone: 505-908-1229", 
                                  font=("Arial", 14), bg='grey', fg='black', wraplength=500, justify='left')
